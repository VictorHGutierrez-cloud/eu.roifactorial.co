(() => {
  ...
  const dictionaries = {
    "pt-PT": {
      ...
      "calculator.cost_comparison": "Comparativo de Custos",
      "calculator.manual_cost": "Custo Manual Estimado",
      "calculator.factorial_cost": "Custo Factorial",
      "calculator.estimated_savings": "Economia estimada:",
      "calculator.report_title": "Receba o resultado detalhado da sua simulação",
      "calculator.report_description": "Preencha para receber por email o relatório completo de ROI e recomendações.",
      "calculator.how_we_calculate": "Como calculamos o ROI",
      "calculator.efficiency_operational": "Eficiência operacional",
      "calculator.efficiency_formula": "Tempo poupado = (transações × tempo médio × 0.6 × multiplicador setor) / 60",
      "calculator.operational_savings": "Economia operacional (€)",
      "calculator.operational_formula": "Tempo poupado × custo médio/hora",
      "calculator.error_reduction": "Redução de erros (€)",
      "calculator.error_formula": "transações × valor médio por erro × (0.3 × multiplicador setor)",
      "calculator.factorial_cost_month": "Custo Factorial (mês)",
      "calculator.factorial_formula": "Core (todos) + Despesas (Business/Enterprise: fixed fee + tiers por utilizador) + Procurement/Faturamento (apenas Business, fixo) + Projetos (por seat, preço varia por plano)",
      "calculator.annual_roi": "ROI anual",
      "calculator.roi_formula": "((poupança total × 12) − (custo mensal × 12)) / (custo mensal × 12) × 100",
      "form.name": "Nome",
      "form.email": "Email",
      "form.company": "Empresa",
      "form.send_report": "Enviar Relatório",
      "features.choose_yours": "🛡️ ESCOLHAS SUAS",
      "features.personalized": "Funcionalidades Personalizadas",
      "features.description": "Soluções de Contabilidade Analítica e Mitigação de Riscos Fiscais para empresas europeias",
      "integrations.title": "🔗 INTEGRAÇÕES",
      "integrations.subtitle": "COM ECOSSISTEMA EUROPEU",
      "integrations.description": "Conecte-se com as principais ferramentas de contabilidade e gestão de RH do mercado europeu",
      "calculator.plan": "Plano",
      "calculator.plan_business": "Business",
      "calculator.plan_enterprise": "Enterprise",
      "calculator.estimated_factorial_cost": "Custo estimado Factorial (mês)",
      "calculator.view_details": "Ver detalhes",
      "integration.a3nom.title": "A3 Nom Integration",
      "integration.a3nom.description": "Automatize suplementos e exporte novos contratados para simplificar os recibos de vencimento.",
      ...
      "compliance.vat_rates.title": "Taxas de IVA Padrão Europeias (2025)",
    ...
    "en": {
      ...
      "calculator.cost_comparison": "Cost Comparison",
      "calculator.manual_cost": "Estimated Manual Cost",
      "calculator.factorial_cost": "Factorial Cost",
      "calculator.estimated_savings": "Estimated savings:",
      "calculator.report_title": "Receive your detailed simulation result",
      "calculator.report_description": "Fill in to receive the complete ROI report and recommendations by email.",
      "calculator.how_we_calculate": "How we calculate ROI",
      "calculator.efficiency_operational": "Operational efficiency",
      "calculator.efficiency_formula": "Time saved = (transactions × average time × 0.6 × sector multiplier) / 60",
      "calculator.operational_savings": "Operational savings (€)",
      "calculator.operational_formula": "Time saved × average cost/hour",
      "calculator.error_reduction": "Error reduction (€)",
      "calculator.error_formula": "transactions × average value per error × (0.3 × sector multiplier)",
      "calculator.factorial_cost_month": "Factorial cost (month)",
      "calculator.factorial_formula": "Core (all) + Expenses (Business/Enterprise: fixed fee + tiers per user) + Procurement/Invoicing (Business only, fixed) + Projects (per seat, price varies by plan)",
      "calculator.annual_roi": "Annual ROI",
      "calculator.roi_formula": "((total savings × 12) − (monthly cost × 12)) / (monthly cost × 12) × 100",
      "form.name": "Name",
      "form.email": "Email",
      "form.company": "Company",
      "form.send_report": "Send Report",
      "features.choose_yours": "🛡️ YOUR CHOICES",
      "features.personalized": "Personalized Features",
      "features.description": "Analytical Accounting and Tax Risk Mitigation Solutions for European companies",
      "integrations.title": "🔗 INTEGRATIONS",
      "integrations.subtitle": "WITH EUROPEAN ECOSYSTEM",
      "integrations.description": "Connect with the main accounting and HR management tools in the European market",
      "calculator.plan": "Plan",
      "calculator.plan_business": "Business",
      "calculator.plan_enterprise": "Enterprise",
      "calculator.estimated_factorial_cost": "Estimated Factorial cost (month)",
      "calculator.view_details": "View details",
      "integration.a3nom.title": "A3 Nom Integration",
      "integration.a3nom.description": "Automate supplements and export new hires to simplify payroll.",
      ...
      "compliance.vat_rates.title": "Standard European VAT Rates (2025)",
    ...
    "es": {
      ...
      "calculator.cost_comparison": "Comparativo de Costos",
      "calculator.manual_cost": "Costo Manual Estimado",
      "calculator.factorial_cost": "Costo Factorial",
      "calculator.estimated_savings": "Ahorro estimado:",
      "calculator.report_title": "Recibe el resultado detallado de tu simulación",
      "calculator.report_description": "Completa para recibir por email el informe completo de ROI y recomendaciones.",
      "calculator.how_we_calculate": "Cómo calculamos el ROI",
      "calculator.efficiency_operational": "Eficiencia operacional",
      "calculator.efficiency_formula": "Tiempo ahorrado = (transacciones × tiempo promedio × 0.6 × multiplicador sector) / 60",
      "calculator.operational_savings": "Ahorro operacional (€)",
      "calculator.operational_formula": "Tiempo ahorrado × costo promedio/hora",
      "calculator.error_reduction": "Reducción de errores (€)",
      "calculator.error_formula": "transacciones × valor promedio por error × (0.3 × multiplicador sector)",
      "calculator.factorial_cost_month": "Costo Factorial (mes)",
      "calculator.factorial_formula": "Core (todos) + Gastos (Business/Enterprise: tarifa fija + niveles por usuario) + Compras/Facturación (solo Business, fijo) + Proyectos (por asiento, precio varía por plan)",
      "calculator.annual_roi": "ROI anual",
      "calculator.roi_formula": "((ahorro total × 12) − (costo mensual × 12)) / (costo mensual × 12) × 100",
      "form.name": "Nombre",
      "form.email": "Email",
      "form.company": "Empresa",
      "form.send_report": "Enviar Informe",
      "features.choose_yours": "🛡️ TUS ELECCIONES",
      "features.personalized": "Funcionalidades Personalizadas",
      "features.description": "Soluciones de Contabilidad Analítica y Mitigación de Riesgos Fiscales para empresas europeas",
      "integrations.title": "🔗 INTEGRACIONES",
      "integrations.subtitle": "CON ECOSISTEMA EUROPEO",
      "integrations.description": "Conéctate con las principales herramientas de contabilidad y gestión de RRHH del mercado europeo",
      "calculator.plan": "Plan",
      "calculator.plan_business": "Business",
      "calculator.plan_enterprise": "Enterprise",
      "calculator.estimated_factorial_cost": "Costo estimado Factorial (mes)",
      "calculator.view_details": "Ver detalles",
      "integration.a3nom.title": "A3 Nom Integration",
      "integration.a3nom.description": "Automatiza suplementos y exporta nuevos contratados para simplificar las nóminas.",
      ...
      "compliance.vat_rates.title": "Tipos de IVA Estándar Europeos (2025)",
    ...
    "fr": {
      ...
      "calculator.cost_comparison": "Comparaison des Coûts",
      "calculator.manual_cost": "Coût Manuel Estimé",
      "calculator.factorial_cost": "Coût Factorial",
      "calculator.estimated_savings": "Économies estimées :",
      "calculator.report_title": "Recevez le résultat détaillé de votre simulation",
      "calculator.report_description": "Remplissez pour recevoir par email le rapport complet de ROI et recommandations.",
      "calculator.how_we_calculate": "Comment nous calculons le ROI",
      "calculator.efficiency_operational": "Efficacité opérationnelle",
      "calculator.efficiency_formula": "Temps économisé = (transactions × temps moyen × 0.6 × multiplicateur secteur) / 60",
      "calculator.operational_savings": "Économies opérationnelles (€)",
      "calculator.operational_formula": "Temps économisé × coût moyen/heure",
      "calculator.error_reduction": "Réduction d'erreurs (€)",
      "calculator.error_formula": "transactions × valeur moyenne par erreur × (0.3 × multiplicateur secteur)",
      "calculator.factorial_cost_month": "Coût Factorial (mois)",
      "calculator.factorial_formula": "Core (tous) + Dépenses (Business/Enterprise : tarif fixe + niveaux par utilisateur) + Achats/Facturation (Business seulement, fixe) + Projets (par siège, prix varie par plan)",
      "calculator.annual_roi": "ROI annuel",
      "calculator.roi_formula": "((économies totales × 12) − (coût mensuel × 12)) / (coût mensuel × 12) × 100",
      "form.name": "Nom",
      "form.email": "Email",
      "form.company": "Entreprise",
      "form.send_report": "Envoyer le Rapport",
      "features.choose_yours": "🛡️ VOS CHOIX",
      "features.personalized": "Fonctionnalités Personnalisées",
      "features.description": "Solutions de Comptabilité Analytique et d'Atténuation des Risques Fiscaux pour les entreprises européennes",
      "integrations.title": "🔗 INTÉGRATIONS",
      "integrations.subtitle": "AVEC L'ÉCOSYSTÈME EUROPÉEN",
      "integrations.description": "Connectez-vous aux principaux outils de comptabilité et de gestion RH du marché européen",
      "calculator.plan": "Plan",
      "calculator.plan_business": "Business",
      "calculator.plan_enterprise": "Enterprise",
      "calculator.estimated_factorial_cost": "Coût estimé Factorial (mois)",
      "calculator.view_details": "Voir détails",
      "integration.a3nom.title": "A3 Nom Integration",
      "integration.a3nom.description": "Automatisez les suppléments et exportez les nouveaux embauchés pour simplifier les bulletins de paie.",
      ...
      "compliance.vat_rates.title": "Taux de TVA Standard Européens (2025)",
    ...
    "de": {
      ...
      "calculator.cost_comparison": "Kostenvergleich",
      "calculator.manual_cost": "Geschätzte Manuelle Kosten",
      "calculator.factorial_cost": "Factorial Kosten",
      "calculator.estimated_savings": "Geschätzte Einsparungen:",
      "calculator.report_title": "Erhalten Sie Ihr detailliertes Simulationsergebnis",
      "calculator.report_description": "Ausfüllen, um den vollständigen ROI-Bericht und Empfehlungen per E-Mail zu erhalten.",
      "calculator.how_we_calculate": "Wie wir ROI berechnen",
      "calculator.efficiency_operational": "Operative Effizienz",
      "calculator.efficiency_formula": "Gesparte Zeit = (Transaktionen × Durchschnittszeit × 0.6 × Sektor-Multiplikator) / 60",
      "calculator.operational_savings": "Operative Einsparungen (€)",
      "calculator.operational_formula": "Gesparte Zeit × Durchschnittskosten/Stunde",
      "calculator.error_reduction": "Fehlerreduzierung (€)",
      "calculator.error_formula": "Transaktionen × Durchschnittswert pro Fehler × (0.3 × Sektor-Multiplikator)",
      "calculator.factorial_cost_month": "Factorial Kosten (Monat)",
      "calculator.factorial_formula": "Core (alle) + Ausgaben (Business/Enterprise: Festpreis + Stufen pro Benutzer) + Beschaffung/Rechnungsstellung (nur Business, fest) + Projekte (pro Sitz, Preis variiert nach Plan)",
      "calculator.annual_roi": "Jährlicher ROI",
      "calculator.roi_formula": "((Gesamteinsparungen × 12) − (monatliche Kosten × 12)) / (monatliche Kosten × 12) × 100",
      "form.name": "Name",
      "form.email": "E-Mail",
      "form.company": "Unternehmen",
      "form.send_report": "Bericht Senden",
      "features.choose_yours": "🛡️ IHRE WAHLEN",
      "features.personalized": "Personalisierte Funktionen",
      "features.description": "Analytische Buchhaltungs- und Steuerrisikominderungslösungen für europäische Unternehmen",
      "integrations.title": "🔗 INTEGRATIONEN",
      "integrations.subtitle": "MIT EUROPÄISCHEM ÖKOSYSTEM",
      "integrations.description": "Verbinden Sie sich mit den wichtigsten Buchhaltungs- und HR-Management-Tools des europäischen Marktes",
      "calculator.plan": "Plan",
      "calculator.plan_business": "Business",
      "calculator.plan_enterprise": "Enterprise",
      "calculator.estimated_factorial_cost": "Geschätzte Factorial Kosten (Monat)",
      "calculator.view_details": "Details anzeigen",
      "integration.a3nom.title": "A3 Nom Integration",
      "integration.a3nom.description": "Automatisieren Sie Zulagen und exportieren Sie neue Mitarbeiter, um die Lohnabrechnung zu vereinfachen.",
      ...
      "compliance.vat_rates.title": "Standard Europäische MwSt-Sätze (2025)",
    ...
    "it": {
      ...
      "calculator.cost_comparison": "Confronto dei Costi",
      "calculator.manual_cost": "Costo Manuale Stimato",
      "calculator.factorial_cost": "Costo Factorial",
      "calculator.estimated_savings": "Risparmio stimato:",
      "calculator.report_title": "Ricevi il risultato dettagliato della tua simulazione",
      "calculator.report_description": "Compila per ricevere via email il report completo di ROI e raccomandazioni.",
      "calculator.how_we_calculate": "Come calcoliamo il ROI",
      "calculator.efficiency_operational": "Efficienza operativa",
      "calculator.efficiency_formula": "Tempo risparmiato = (transazioni × tempo medio × 0.6 × moltiplicatore settore) / 60",
      "calculator.operational_savings": "Risparmio operativo (€)",
      "calculator.operational_formula": "Tempo risparmiato × costo medio/ora",
      "calculator.error_reduction": "Riduzione errori (€)",
      "calculator.error_formula": "transazioni × valore medio per errore × (0.3 × moltiplicatore settore)",
      "calculator.factorial_cost_month": "Costo Factorial (mese)",
      "calculator.factorial_formula": "Core (tutti) + Spese (Business/Enterprise: tariffa fissa + livelli per utente) + Procurement/Fatturazione (solo Business, fisso) + Progetti (per posto, prezzo varia per piano)",
      "calculator.annual_roi": "ROI annuale",
      "calculator.roi_formula": "((risparmio totale × 12) − (costo mensile × 12)) / (costo mensile × 12) × 100",
      "form.name": "Nome",
      "form.email": "Email",
      "form.company": "Azienda",
      "form.send_report": "Invia Report",
      "features.choose_yours": "🛡️ LE TUE SCELTE",
      "features.personalized": "Funzionalità Personalizzate",
      "features.description": "Soluzioni di Contabilità Analitica e Mitigazione dei Rischi Fiscali per aziende europee",
      "integrations.title": "🔗 INTEGRAZIONI",
      "integrations.subtitle": "CON ECOSISTEMA EUROPEO",
      "integrations.description": "Connettiti con i principali strumenti di contabilità e gestione HR del mercato europeo",
      "calculator.plan": "Piano",
      "calculator.plan_business": "Business",
      "calculator.plan_enterprise": "Enterprise",
      "calculator.estimated_factorial_cost": "Costo stimato Factorial (mese)",
      "calculator.view_details": "Visualizza dettagli",
      "integration.a3nom.title": "A3 Nom Integration",
      "integration.a3nom.description": "Automatizza supplementi ed esporta nuovi assunti per semplificare le buste paga.",
      ...
      "compliance.vat_rates.title": "Aliquote IVA Standard Europee (2025)",
